        ...
        <ScrollArea className="mt-8 max-h-[420px] pr-6">
          {server?.member?.map((members) => (
            <div key={members.id} className="flex items-center gap-x-2 mb-6">
              <UserAvatar className="" src={members.profile.imageUrl} />
                    ...
                    <DropdownMenuContent side="left">
                      <DropdownMenuSub>
                        ...
                        <DropdownMenuPortal>
                          <DropdownMenuSubContent>
                            <DropdownMenuItem
                              onClick={() => onRoleChange(members.id, "GUEST")}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() => onRoleChange(members.id, "MODERATOR")}
                            >
